...
export default function DashboardNews() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setForm({ title: '', content: '', category: 'general', published: true, image: '' })
    },
    ...
    <div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 mb-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          >
            {['general','resultado','transferencia','torneo','selección'].map(c => (
          ...
          <textarea
            ...
            rows={5}
            className="bg-gray-800 border border-gray-700 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:border-orange-500 resize-none"
            required
          />
          <ImageUpload
          ...
          <button
            ...
            className="bg-orange-500 hover:bg-orange-600 py-2.5 rounded-lg font-semibold transition disabled:opacity-50"
          >
      ...
      <div className="flex flex-col gap-4">
        {data?.data?.news?.map(n => (
          <div key={n._id} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
            {n.image && (
            ...
            <div className="p-5 flex justify-between items-start">
              ...
              <button
                ...
                className="ml-4 text-red-400 hover:text-red-300 text-sm border border-red-900 hover:border-red-400 px-3 py-1 rounded-lg transition shrink-0"
              >
                Eliminar
              </button>
            </div>
